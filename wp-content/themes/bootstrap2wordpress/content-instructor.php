...
<section id="instructor">
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-md-6"> <!--Use col 8 wen on small screens & col 6 wen on medium screens-->
                <div class="row">
                    <div class="col-lg-8">
                        <h2><?php print($instructor_section_title);  ?> <small><?php echo $instructor_name ; ?></small></h2>
                    </div>


                    <div class="col-lg-4">
<!-- IF USER ENTERED TWITTER NAME -->
...
<!-- IF USER ENTERED FACEBOOK NAME -->
                       <?php if (!empty($facebook_username) ) : ?>                                                                        
                        <a href="https://facebook.com/<?php echo $twitter_username ; ?>" target="_blank" class="badge social facebook">
